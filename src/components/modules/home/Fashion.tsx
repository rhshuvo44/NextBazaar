...
const Fashion = () => {
  return (
    <section className="min-h-screen bg-base-100 flex flex-col lg:flex-row items-stretch">
      ...
      <div className="flex-1 relative w-full min-h-screen lg:h-auto overflow-hidden group">
        <Image
          src={fashon1.src}
